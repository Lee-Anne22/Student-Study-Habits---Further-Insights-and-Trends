...
The data was first prepared by cleaning which consisted of filling missing values with averages and removing any spacing between words. After cleaning, encoding of categorical variables ( 'part-time job', 'diet quality', 'internet quality', and 'extracurricular activity') using the Sci-kit Learn 'StandardScaler' was implemented. These new encoded categories were added to a copy of the csv and saved as 'student_habits_encoded'.csv which was used for the exploratory data analysis and training the machine models.
...
-   Stacked bar plot
    -   The relationship between internet quality and exam scores by gender, further explored using a 3D surface plot.
-   Violin plot
...
-   High correlation between exam scores and both mental health rating and study hours were found.

-   **Suggested Niche Industries: Health Focused**

1.  Exam success isn’t random — it scales with study time, peaking around 3.5 hours.
...
-   Better internet access were correlated to higher exam scores, regardless of gender.
